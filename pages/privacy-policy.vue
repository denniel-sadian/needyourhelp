<template>
  <v-container class="subheading">
    ...
    <p>
      ...
      <b>https://needyourhelp.herokuapp.com</b> website (the "Service").
    </p>

    <p>
      This page informs you of our policies regarding the collection, use, and
      disclosure of personal data when you use our Service and the choices you
      have associated with that data. Our Privacy Policy for Need Your Help is
    ...
    <p>
      ...
      Philippines and process it there.
    </p>
    <p>
    ...
    <p>
      Need Your Help will take all steps reasonably necessary to ensure that
    ...
    <ul>
      ...
      <li>To protect and defend the rights or property of Need Your Help</li>
      <li>
    ...
    <ul>
      <li>By email: sadiandenniel@gmail.com</li>
    </ul>
  </v-container>
</template>
...
export default {
  head() {
    return {
      title: 'Need Your Help - Privacy Policy',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Privacy Policy of Need Your Help.'
        },
        {
          hid: 'twitter-title',
          name: 'twitter:title',
          content: 'Need Your Help - Privacy Policy'
        },
        {
          hid: 'twitter-desc',
        ...
        },
        {
          hid: 'site_url',
          property: 'og:url',
          content: 'https://needyourhelp.herokuapp.com/privacy-policy'
        },
        {
          hid: 'site_title',
          property: 'og:title',
